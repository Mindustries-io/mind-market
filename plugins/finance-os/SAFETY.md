# Finance OS — Safety & Disclaimer

**Not professional advice.** Finance OS produces AI-assisted drafts, estimates, and preparation materials. Nothing it outputs is tax advice, accounting advice, legal advice, or investment advice. Tax calendars, prepayment estimates, VAT treatments, deductibility flags, and reserve recommendations are planning aids to review with a qualified tax professional or accountant before you rely on them, file anything, or make commitments.

**Figures are only as good as the data provided.** Finance OS works from what you paste and configure. Forecasts, runway numbers, and price-impact estimates carry every assumption forward — check the labeled assumptions list in each output, and verify totals against your actual bank and accounting records before acting on them.

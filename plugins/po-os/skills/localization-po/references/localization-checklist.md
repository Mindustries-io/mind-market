...
Feed this into the Localization Brief format (see `lead-po/references/output-formats.md`). Derive Backlog Items from each unchecked box — one backlog item per unchecked item, with priority driven by:
